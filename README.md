...
If you want something more barebones, check out [gb-boilerplate](https://codeberg.org/ISSOtm/gb-boilerplate).
...
- [Variable-width font engine](https://codeberg.org/ISSOtm/gb-vwf#readme)
- [Structs in RGBDS](https://codeberg.org/ISSOtm/rgbds-structs#readme)
- [Sound drivers](https://codeberg.org/ISSOtm/fortISSimO/wiki/Drivers-comparison)

[WSL]: https://learn.microsoft.com/en-us/windows/wsl/install
[MSYS2]: https://msys2.org
[the wiki]: https://codeberg.org/ISSOtm/gb-starter-kit/wiki
